...
! function(t, e) {
    ...
    function m(t, e) {
        ...
        function Q(n) {
            q = n.selection ? n.selection() : n, e || (e = (e = m[0] instanceof Date ? r.scaleTime() : r.scaleLinear()).domain(m).range(1 === t || 3 === t ? [0, g] : [p, 0]).clamp(!0)), P = r.scaleLinear().range(e.range()).domain(e.range()).clamp(!0), o = o.map((function(t) {
                return r.scaleLinear().range(m).domain(m).clamp(!0)(t)
            })), A = A || e.tickFormat(), D = D || A || e.tickFormat(), q.selectAll(".axis").data([null]).enter().append("g").attr("transform", R(7 * F)).attr("class", "axis");
            var i = q.selectAll(".slider").data([null]),
                c = i.enter().append("g").attr("class", "slider").attr("cursor", 1 === t || 3 === t ? "ew-resize" : "ns-resize").call(u.drag().on("start", d((function(n) {
                    ...
                    G(u), j.call("start", i, 1 === u.length ? u[0] : u), N(u, !0)
                }))).on("drag", d((function(e) {
                    var n = f(P(3 === t || 1 === t ? e.x : e.y));
                    G(n), j.call("drag", i, 1 === n.length ? n[0] : n), N(n, !0)
                }))).on("end", d((function(e) {
                    l.select(this).classed("active", !1);
                    var n = f(P(3 === t || 1 === t ? e.x : e.y));
                    G(n), j.call("end", i, 1 === n.length ? n[0] : n), N(n, !0), z = null
                }))));
            ...
            s.append("path").attr("transform", "rotate(" + 90 * (t + 1) + ")").attr("d", x).attr("class", "handle").attr("aria-label", "handle").attr("aria-valuemax", m[1]).attr("aria-valuemin", m[0]).attr("aria-valuenow", (function(t) {
                ...
                switch (t.key) {
                    case "ArrowLeft":
                    case "ArrowDown":
                        w ? Q.value(l(w[Math.max(0, r - 1)])) : Q.value(l(+o[e.index] - n)), t.preventDefault();
                        break;
                    case "PageDown":
                        w ? Q.value(l(w[Math.max(0, r - 2)])) : Q.value(l(+o[e.index] - 2 * n)), t.preventDefault();
                        break;
                    case "ArrowRight":
                    case "ArrowUp":
                        w ? Q.value(l(w[Math.min(w.length - 1, r + 1)])) : Q.value(l(+o[e.index] + n)), t.preventDefault();
                        break;
                    case "PageUp":
                        w ? Q.value(l(w[Math.min(w.length - 1, r + 2)])) : Q.value(l(+o[e.index] + 2 * n)), t.preventDefault();
                        break;
                    case "Home":
                        Q.value(l(m[0])), t.preventDefault();
                        break;
                    case "End":
                        Q.value(l(m[1])), t.preventDefault()
                }
                ...
                return A(o[e])
            })), n.select(".track").attr(T + "2", e.range()[1] + 8 * L), n.select(".track-inset").attr(T + "2", e.range()[1] + 8 * L), O && n.select(".track-fill").attr(T + "2", 1 === o.length ? e(o[0]) : e(o[1])), n.select(".track-overlay").attr(T + "2", e.range()[1] + 8 * L), n.select(".axis").call(_(e).tickFormat(A).ticks(M).tickValues(y).tickPadding(b)), q.select(".axis").select(".domain").remove(), n.select(".axis").attr("transform", R(7 * F)), n.selectAll(".axis text").attr("fill", "#aaa").attr(V, F * (17 + b)).attr("dy", 1 === t ? "0em" : 3 === t ? ".71em" : ".32em").attr("text-anchor", 2 === t ? "start" : 4 === t ? "end" : "middle"), n.selectAll(".axis line").attr("stroke", "#aaa"), n.selectAll(".parameter-value").attr("transform", (function(t) {
                return E(e(t.value))
            })), U(), H = q.selectAll(".parameter-value text"), B = q.select(".track-fill")
        }
            ...
            if (q && v) {
                ...
                if (o.forEach((function(e) {
                    ...
                    H.nodes().forEach((function(t, a) {
                        e = t.getBoundingClientRect(), n = t.getAttribute("transform").split(/[()]/)[1].split(",")["x" === T ? 0 : 1], r[a] = e[T] - parseFloat(n), l[a] = e["x" === T ? "width" : "height"]
        ...
        function C(t) {
            ...
            if (k) {
                var n = (t - m[0]) % k,
                    r = t - n;
                return 2 * n > k && (r += k), t instanceof Date ? new Date(r) : r
            }
            return t
        }
        ...
        return e && (m = [a.min(e.domain()), a.max(e.domain())], 1 === t || 3 === t ? g = a.max(e.range()) - a.min(e.range()) : p = a.max(e.range()) - a.min(e.range()), e = e.clamp(!0)), Q.min = function(t) {
